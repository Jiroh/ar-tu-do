...
class StraightDrive
{
    ...
    float calcBreakingDistance(float current_speed, float target_speed, float distance, float acceleration, float decceleration);
    float calcMaxSpeed(float current_speed, float target_speed, float distance, float acceleration, float decceleration);
    ...
    */
    ...
    float calcTimeLimit(float current_speed, float target_speed, float distance, float acceleration, float decceleration) {
        float max_velocity = std::sqrt((2*distance*acceleration*decceleration+current_speed*current_speed*decceleration+target_speed*target_speed*acceleration)/(acceleration+decceleration));
